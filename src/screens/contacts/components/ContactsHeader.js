...
class ContactsHeader extends React.PureComponent {
    render() {
        return (<header className="contactsHeader">
            <IosArrowBack className="contactsHeader__iconBack" fontSize="20px" color="#6D6D6D"/>
            <h1 className="contactsHeader__title">Контакты</h1>
            <IosSettingsOutline className="contactsHeader__iconSettings" fontSize="20px" color="#6D6D6D"/>
        </header>);
    }
}
